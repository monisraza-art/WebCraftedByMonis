          ...
          {topSalesData.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div
                ...
                className="cursor-zoom-in w-[70%] mx-auto rounded-xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform"
              >
                <img
                  src={item.image}
                  alt={item.name}
              ...
              {/* Description */}
              <p className="mt-6 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto text-base sm:text-lg">
                {item.description}
              </p>
            </div>
          ))}
